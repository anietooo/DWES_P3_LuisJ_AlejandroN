...
<body>
    ...
    insertarProducto(new Monitor(170, 4, "ASUS VG27AQ1A", "Monitor IPS WQHD (2560x1440) de 27” con 170 Hz de refresco* diseñado para gamers profesionales y disfrutar de una experiencia de juego envolvente.
    La tecnología ASUS Extreme Low Motion Blur (ELMB) elimina los defectos gráficos y hacen que las escenas borrosas cobren nitidez.", 100, 5));

    insertarProducto(new Monitor(180, 5, "LG 24GS50F-B", "Cuando juegas a 180 Hz y 1 ms, cambia la historia.
    Frecuencia de actualización de 180 Hz y 1ms (GtG) de velocidad de respuesta.
    Disfruta de una experiencia visual más inmersiva y con colores vibrantes gracias a NTSC 72%.
    La tecnología AMD FreeSync minimiza la fragmentación de la imagen disfrutando de movimientos más fluidos.", 150, 5));

    insertarProducto(new Monitor(360, 6, "BenQ ZOWIE XL2411P", "Monitor de 1 ms con una frecuencia de refresco de 144 Hz que ofrece una experiencia muy suave en juegos de disparos en primera persona (FPS) y juegos de campo de batalla multijugador en línea (MOBA)
    ", 200, 5));
